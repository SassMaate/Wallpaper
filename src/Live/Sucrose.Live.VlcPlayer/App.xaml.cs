...
using SSEVPVG = Sucrose.Shared.Engine.VlcPlayer.View.Gif;
using SSEVPVV = Sucrose.Shared.Engine.VlcPlayer.View.Video;
...
namespace Sucrose.Live.VlcPlayer
{
    /// <summary>
    ...
    public partial class App : Application
    {
        ...
        protected void Message(Exception Exception, bool Show)
        {
            if (HasError)
            {
                ...
                string Path = SMMI.VlcPlayerLiveLogManager.LogFile();

                SSSHWG.Start(SMMRA.VlcPlayerLive, Exception, Show, Path);
        ...
        protected void Configure()
        {
            ...
            if (SMMI.LibrarySettingManager.CheckFile() && !string.IsNullOrEmpty(SSEMI.LibrarySelected))
            {
                ...
                SSEVPMI.VlcPath = Path.Combine(SMMRP.ApplicationData, SMMRG.AppName, SMMRF.Cache, SMMRF.VlcPlayer);
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            if (SSSHI.Basic(SMMRM.Live, SMMRA.VlcPlayerLive) && SSEHR.Check())
            {
                SSSHS.Apply();
