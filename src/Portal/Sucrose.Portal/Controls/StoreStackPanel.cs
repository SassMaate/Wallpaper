...
{
    public class StoreStackPanel : StackPanel, IDisposable
    {
        public static readonly DependencyProperty ItemMarginProperty = DependencyProperty.Register("ItemMargin", typeof(Thickness), typeof(StoreStackPanel), new FrameworkPropertyMetadata(new Thickness(0)));
        ...
        public static readonly DependencyProperty MaxItemsPerRowProperty = DependencyProperty.Register("MaxItemsPerRow", typeof(int), typeof(StoreStackPanel), new FrameworkPropertyMetadata(int.MaxValue, MaxItemsPerRowPropertyChanged));
        ...
        {
            (d as StoreStackPanel)?.InvalidateMeasure();
        }
